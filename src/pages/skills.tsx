...
import {
  ...
  Braces as TypeScriptIcon,
  Wand2 as WordPressIcon,
  Heart as LovableIcon,
...
const Skills: React.FC = () => {
  ...
  const skillsList = [
    ...
    },
    {
      ...
      projectsUsed: ['Type-Safe Development', 'React Applications', 'Backend Systems'],
    },
    ...
    },
    {
      ...
      category: 'Automation & Low-Code',
      proficiency: 0,
      icon: <WordPressIcon size={16} />,
      projectsUsed: ['Website Development', 'Blog Setup', 'Content Management'],
    },
    {
      name: 'Lovable',
      category: 'Automation & Low-Code',
      proficiency: 0,
      icon: <LovableIcon size={16} />,
      projectsUsed: ['Rapid Prototyping', 'AI-Powered Development', 'Web Applications'],
    },
    {
      name: 'Airtable',
      category: 'Automation & Low-Code',
    ...
    },
    {
      ...
      category: 'Engineering Foundations',
      proficiency: 0,
      icon: <SystemDesignIcon size={16} />,
      projectsUsed: ['Scalable Architectures', 'Database Design', 'Microservices'],
    },
    {
      name: 'DBMS',
      category: 'Engineering Foundations',
    ...
    <section id="skills" className="skills scroll-section" aria-label="Skills">
      <div className="container">
        <SectionHeader
          ...
          subtitle="Programming Languages • Full-Stack Development • Automation & Low-Code • DevOps & Cloud • AI & Machine Learning • Engineering Foundations"
          align="center"
          gradient
        />
